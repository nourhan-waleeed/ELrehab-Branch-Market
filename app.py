...
common_layout = {
        ...
        'paper_bgcolor': 'black',
        'font': {
            'color': 'white'  # Set the text color for title and axis labels to white
        },
        'xaxis': {
            'title': {
                'font': {
            ...
            'tickfont': {
                'color': 'white'  # Set x-axis tick labels text color to white
            }
        },
        'yaxis': {
            'title': {
            ...
            'tickfont': {
                'color': 'white'  # Set y-axis tick labels text color to white
            }
        }
    }
...
custom_color_palette = ['#682C0E', '#C24914', '#F9E0AE', '#FC8621', '#346751','#243763']


app.layout = html.Div(style={'font-family': 'Arial, sans-serif', 'padding': '20px', 'background-color': 'black', 'text-align': 'right', 'color': 'white', 'font-size': '22px'}, children=[
    html.Div([
        html.Img(src=('/assets/img.png')),
        html.H2(children='فتح الله فرع الرحاب' ,style={'text-align': 'right'})
    ],className="banner"),
    ...
    dcc.RadioItems(
        ...
        labelStyle={'display': 'block', 'margin-bottom': '10px', 'font-weight': 'bold', 'color': 'white'}
     ),
...
],style={'display': 'flex', 'flex-direction': 'row', 'background-color': 'black', 'color': 'white'}
)
,
...
html.Div([
    dcc.Graph(figure=px.scatter(
        ...
        color_discrete_sequence=['#ED7D31', '#F6F1EE', '#6C5F5B', 'orange']
    ).update_layout(
    ...
    style_data_conditional=[
        {
            ...
            'color': 'white'  # You may need to set text color to ensure readability
        },
        {
            'if': {'row_index': 'even'},
   ...
   html.Div([
     ...
     dcc.Graph(
    figure = px.scatter(customer_purchase, x='duration', y='عدد الزيارات', title='Scatter Plot of Duration vs. عدد الزيارات',size='معدل الشراء',color_discrete_sequence=['orange']
).update_layout(
    xaxis_title='Duration',
    yaxis_title='عدد الزيارات',
    showlegend=False , **common_layout))
    ...
    html.Div([
            ...
            html.H1(children='شكاوي فرع الرحاب',
                     style={'color': '#333', 'font-weight': 'bold','text-align': 'center','color':'white','font-size':'30px'}
                    ),       
    ],className='banner2'),
    ...
    html.Div([
        ...
        labelStyle={'display': 'block', 'margin-bottom': '17px', 'font-weight': 'bold', 'color': 'white','font-size':'25px'})
   ...
   html.Div([
    ...
    dash_table.DataTable(
        ...
        style_header=dict(backgroundColor="#FF9130",color='white'),
        style_data=dict(backgroundColor="#333333"),
        style_data_conditional=[
            {
                'if': {'filter_query': '{Ticket No} = 608494.0'},
                'backgroundColor': 'black'  # You can assign a unique color for each customer ID here
            },
            {
...
if __name__ == '__main__':
    app.run_server(debug=True,port=8804)
